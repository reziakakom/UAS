...
<form action="edit.php" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" method="post">
  <?php
      include("koneksi.php");      
    $id = $_GET['id'];
    $query = mysqli_query($konek,"SELECT * FROM mhs WHERE id = '$id'") or die(mysql_connect_error());
    $data = mysqli_fetch_array($query);     

  ?>
<h2 class="w3-center">Masukkan Data Mahasiswa</h2>
 
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
    <div class="w3-rest">
      <input type="hidden" name="id" value="<?php echo $data['id'] ?>">
      <input class="w3-input w3-border" name="nama" type="text" placeholder="Masukkan Nama" value="<?php echo $data['nama'] ?>">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="nim" type="text" placeholder="Masukkan Nim" value="<?php echo $data['nim'] ?>">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-envelope-o"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="email" type="text" placeholder="Masukkan Email" value="<?php echo $data['email'] ?>">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-phone"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="nohp" type="text" placeholder="Masukkan Nomor HP" value="<?php echo $data['nohp'] ?>">
    </div>
</div>
